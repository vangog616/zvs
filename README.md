3xui-shop (No Payment Version)
=======

**This is a modified version of the 3xui-shop project without payment systems. It works with 3X-UI panel for manual VPN subscription management through Telegram.**

## Key differences from the original project:
- All payment systems have been removed
- Subscription management is done manually by administrators 
- Administrators receive notification of new subscription requests
- Administrators can approve or deny subscription requests
